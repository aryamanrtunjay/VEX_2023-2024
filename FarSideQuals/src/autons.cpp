...
void AllAutons() {
  ...
  chassis.pid_drive_set(-14_in, DRIVE_SPEED, false);
  pros::Task::delay(700);
  chassis.pid_turn_set(18_deg, TURN_SPEED, false);
  pros::Task::delay(500);
  chassis.pid_drive_set(52_in, DRIVE_SPEED, false);
  ...
  pros::Task::delay(800);
  wings.set_value(true);
  chassis.pid_drive_set(-42_in, DRIVE_SPEED, false);
  pros::Task::delay(800);
  chassis.pid_turn_set(90_deg, TURN_SPEED, false);
  pros::Task::delay(800);
  chassis.pid_drive_set(-55_in, DRIVE_SPEED, false);
  pros::Task::delay(800);
  wings.set_value(false);
}
